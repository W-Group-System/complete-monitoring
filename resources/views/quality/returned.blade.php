    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="card-body">
                    <h4 class="ibox-title">
                        <form method="GET" action="{{ url('/returned_quality') }}" class="form-inline" style="margin-bottom: 15px;" onsubmit="show()">
                                            ...
                                            <tr> 
                                                <td style="center">
                                                    @if ($grpo->quality_created)
                                                        ...
                                                        @if (request()->routeIs('returned_quality'))
                                                        ...
                                                        @elseif (request()->routeIs('ccc_returned_quality'))
